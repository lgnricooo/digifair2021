...
<body>
      ...
      <li class="nav-item ">
        ...
        <ul class="nav sub-menu">
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="{{ route('admin.export') }}" class="nav-link ">Export</a>
            </li>
          </ul>
        </div>
      </li>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">ICT - KAMUSTAHAN</li>
  </ol>
</nav>
...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">ICT - KAMUSTAHAN Attendance</h6>
    ...
    <script type="text/javascript">
        $(function(){
			...
			var table = $('.datatable').DataTable({
                ...
                serverSide: true,
				responsive: true,
                ajax: "{{ route('admin.kamustahanAttendance') }}",
                columns: [
                    {
                        data: 'par_image',
                        name: 'par_image',
