...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Slide Presentation (JHS)</li>
  </ol>
</nav>
...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Slide Presentation (JHS) Attendance</h6>
  ...
  <p class="text-muted text-center text-md-left mb-0 d-none d-md-block">Handcrafted With <i class="mb-1 text-primary ml-1 icon-small" data-feather="heart"></i></p>
    ...
    <script type="text/javascript">
        ...
        dom: 'Bfrtip',
                ...
                serverSide: true,
				responsive: true,
                ajax: "{{ route('admin.slidejhsAttendance') }}",
                columns: [
                    {
                        data: 'par_image',
                        name: 'par_image',
